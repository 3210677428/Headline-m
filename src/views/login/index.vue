<template>
  <div class="login-container">
    ...
    <!-- 登录表单 -->
    <van-cell-group>
      <van-field v-model="user.phone"  icon-prefix="lsongtao" left-icon="shouji" placeholder="请输入手机号" />
      <van-field v-model="user.code" clearable icon-prefix="lsongtao" left-icon="yanzhengma" placeholder="请输入验证码">
        <!-- 自定义插槽 -->
        <template #button>
